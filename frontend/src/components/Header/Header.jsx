      ...
      <nav className="mx-auto flex max-w-7xl items-center py-2">
        ...
        <div className="fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-white bg-[#121212] duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none">
          ...
          <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
            ...
            {/* // When checking auth, if the user isn't login. Show this */}
            {/* ------------ */}
            <Link to={'/login'} className="w-full bg-[#383737] px-3 py-2 hover:bg-[#4f4e4e] md:w-auto md:bg-transparent">
              Log in
            </Link>
            <Link to={'/register'} className="mr-1 w-full bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] md:w-auto">
              Sign up
            </Link>
            {/* ------------- */}

            {/* // {/* Else, show this If the User is login, show this. */}
            {/* ------------- */}
