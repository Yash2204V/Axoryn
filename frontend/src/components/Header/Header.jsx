...
function Header() {
  ...
  const { status: isLoggedIn, userData } = useSelector((state) => state.user);
            ...
            {!isLoggedIn ? (
              ...
              <div className="flex w-full items-center gap-4 md:w-auto">
                ...
                <button
                  ...
                  className="mr-1 w-full bg-red-600 px-3 py-2 text-center font-bold text-white shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] md:w-auto"
                >
                  Logout
                </button>
              </div>
